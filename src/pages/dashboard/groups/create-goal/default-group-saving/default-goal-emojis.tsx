...
export const DefaultGoalEmojis: React.FC<{ onNextClick?: () => void; loading?: boolean }> = ({
  onNextClick,
  loading,
}) => {
  ...
  if (step !== DefaultGroupSavingsSteps.SELECT_EMOJI || form?.nature !== GroupSavingsType.DEFAULT) {
    return null;
  }
