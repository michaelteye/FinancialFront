...
function SvgSavingsAccount(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg width={20} height={18} fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      ...
      <path
        opacity={0.4}
        d="M14.037 9.297c.21.95 1.043 1.62 1.996 1.603h3.25a.726.726 0 00.717-.734V7.634a.728.728 0 00-.718-.734h-3.326c-1.083.003-1.958.902-1.956 2.01 0 .13.013.26.037.387z"
        fill="#3B6096"
      />
      <circle cx={16} cy={8.9} r={1} fill="#3B6096" />
    </svg>
  );
}

export default SvgSavingsAccount;
